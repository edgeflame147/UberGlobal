...
function pathFinding(dest) {
  ...
  */
  ...
  if(dest == 2) {
    document.getElementById("popup1").innerHTML += "<br> Steps Needed: "+stepsForTravel.toString(10);
    document.getElementById("popup1").innerHTML += "<br> Time Needed: "+timeForTravel.toString(10)+" minutes";
  }
  else if(dest == 0) {
    document.getElementById("popup2").innerHTML += "<br> Steps Needed: "+stepsForTravel.toString(10);
    document.getElementById("popup2").innerHTML += "<br> Time Needed: "+timeForTravel.toString(10)+" minutes";
  }
  else if(dest == 1) {
    document.getElementById("popup3").innerHTML += "<br> Steps Needed: "+stepsForTravel.toString(10);
    document.getElementById("popup3").innerHTML += "<br> Time Needed: "+timeForTravel.toString(10)+" minutes";
  }
  else if(dest == 4) {
    document.getElementById("popup4").innerHTML += "<br> Steps Needed: "+stepsForTravel.toString(10);
    document.getElementById("popup4").innerHTML += "<br> Time Needed: "+timeForTravel.toString(10)+" minutes";
  }
  else if(dest==3) {
